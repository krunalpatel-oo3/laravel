					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="{{route('admin.poducts.list')}}"><i class="icon-width"></i> <span>Products</span></a></li>
								<!-- /main -->
							</ul>
						</div>
					</div>
...
<div class="myloader hide">
	<div class="pace-demo">
		<div class="theme_xbox_sm"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div></div>
	</div>
</div>
@yield('script')